...
export default function PostDetail() {
  ...
  return (
    ...
    <div style={{ padding: "2rem", maxWidth: "800px", margin: "0 auto" }}>
      ...
      <p style={{ lineHeight: "1.6", fontSize: "1.1rem" , fontWeight : "bold" }}>{post.Paragraph1}</p>
      <p style={{ lineHeight: "1.6", fontSize: "1.1rem" }}><span style={{ fontWeight: "bold" , textDecoration: "underline" }}>{post.header1}</span>{post.Paragraph2}</p>
